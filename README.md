...
- 📬 **[IDM Inbox](https://idm-inbox.site.identitymd.eth.limo)** — inbox for on-chain messages: the dev board pinned on the home page, any address readable as threads, and messages or replies sent from your own wallet. Built by the swarm, no backend, no tracking ([source](https://github.com/identity-md-launches/launch-181-fix-idm-inbox-app))
